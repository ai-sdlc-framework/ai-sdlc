...
## [0.10.0](https://github.com/ai-sdlc-framework/ai-sdlc/compare/orchestrator-v0.9.0...orchestrator-v0.10.0) (2026-05-04)
...
* **deps:** dor gate enforce mode + RFC-0011 v4 + parent task progress (AISDLC-115.9) ([76dc278](https://github.com/ai-sdlc-framework/ai-sdlc/commit/76dc27823b8085f45ddc833c97e54b370a8d12a6))
...
* **orchestrator:** interactive init wizard + scaffold gate workflow (AISDLC-143) ([2ccf3c4](https://github.com/ai-sdlc-framework/ai-sdlc/commit/2ccf3c47727c4294a99242c51744816d0701d24e))
...
* promote AI_SDLC_PARALLELISM to default-on (AISDLC-116) ([b155123](https://github.com/ai-sdlc-framework/ai-sdlc/commit/b1551230a5cf77f933864c1a668bfd0b50e90afb))
...
* **orchestrator:** admit confidence honors enrichment-success above 0.5 default (AISDLC-172) ([056a82e](https://github.com/ai-sdlc-framework/ai-sdlc/commit/056a82e37496069b590b79e47c423621d449d8c7))
...
* **orchestrator:** isolate init-workspace test from host git origin (AISDLC-134) ([7905a50](https://github.com/ai-sdlc-framework/ai-sdlc/commit/7905a5082bfec9161886dac492a1bdccf61a4e04))
...
* **orchestrator:** re-apply / harden AISDLC-189 init-workspace test fix (AISDLC-159) ([228af66](https://github.com/ai-sdlc-framework/ai-sdlc/commit/228af66a1c3c275c4fb52f3fccf475a1f838d576))
...
* **orchestrator:** unset GIT_* env in init-workspace test + direct .git/ writes ([2ed1039](https://github.com/ai-sdlc-framework/ai-sdlc/commit/2ed10390a26944b6dfa6bd2b60f4e697c1856449))
...
* **orchestrator:** wire designAuthority diagnostic into HC_design (AISDLC-171) ([be1615c](https://github.com/ai-sdlc-framework/ai-sdlc/commit/be1615c12905927f17e08ca778fa88bc746e11f0))
* pin detectGitRemote cwd via git -C to avoid host git origin bleed (AISDLC-104) ([c84c595](https://github.com/ai-sdlc-framework/ai-sdlc/commit/c84c595a8b6b4659be8671777bb2a03784f6ec50))
...
* validate changedFileDeltas element shape (review feedback) ([a2ee649](https://github.com/ai-sdlc-framework/ai-sdlc/commit/a2ee6491d62cef883b4dd505a85ed953255d9edf))
