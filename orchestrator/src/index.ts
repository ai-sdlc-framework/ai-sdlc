...
export {
  ...
  type TriggerConfig,
  type CalibrationLockConfig,
  type DIDRevisionProposalEvent,
  type SoulHealthDiagnosticEvent,
  type DIDRevisionProposalExpiredEvent,
  type ProposalRejectionRecord,
  type EvaluateRevisionProposalInput,
  type EvaluateRevisionProposalResult,
} from './sa-scoring/revision-proposal.js';
export {
