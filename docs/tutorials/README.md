...
Step-by-step walkthroughs for common AI-SDLC scenarios.

## Tutorials

1. **[Setting up a basic pipeline](01-basic-pipeline.md)** — Configure triggers, providers, and stages
2. **[Adding quality gates](02-quality-gates.md)** — Enforce test coverage, security scans, and review requirements
...
Have a tutorial idea? See [CONTRIBUTING.md](../../CONTRIBUTING.md).
