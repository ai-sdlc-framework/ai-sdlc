...
- `reference/src/core/generated-schemas.ts` — auto-generated from `spec/schemas/`
...
- AISDLC-258 — shared-churn exclude list for pnpm-lock.yaml, CHANGELOG, generated-schemas
