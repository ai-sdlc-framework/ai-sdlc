...
| 0026  | Exploration Workstream Pattern                                                                       | Reserved    | Placeholder  | dominique@reliablegenius.io                                      | (none yet — reservation; draft ships in follow-on PR)                             | First-class "spike/research" workstream type that bypasses DoR's decision-frontloading gate (since the goal IS to discover the unknowns); explicit time-box + handoff back to standard execution flow when knowns crystallize. Addresses VISION.md §5 exploration-mode gap. |
