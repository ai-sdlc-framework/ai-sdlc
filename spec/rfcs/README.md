...
| 0009  | Tessellated Design Intent Documents                                                                  | Draft       | Draft        | Alexander Kline                                                  | (in-flight — see branch `rfc/0009-tessellated-design-intent-documents`)           | OQ-3 carved out two follow-on patterns reserved as RFC-0017 and RFC-0018.                                   |
...
| 0022  | Compliance Posture + Audit Surface                                                                   | Draft       | Draft        | dominique@reliablegenius.io                                      | [RFC-0022-compliance-posture-audit-surface.md](RFC-0022-compliance-posture-audit-surface.md) | Adopter declares regulatory posture (HIPAA/SOC2/PCI-DSS/GDPR/etc.); framework derives gate defaults (DB pool isolation, secret-scan strictness, attestation requirement, retention) and exports audit evidence packs. RFC-0020 and RFC-0021 reserved for separate in-flight RFCs (OQ-7 carve-outs); pre-allocating 0022 here. |

**Next available number:** RFC-0020.
