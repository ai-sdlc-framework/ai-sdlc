...
describe('Reconcilers', () => {
  describe('createDogfoodPipelineReconciler()', () => {
    it('creates a pipeline reconciler function', () => {
      const reconciler = createDogfoodPipelineReconciler({
  ...
  describe('createDogfoodGateReconciler()', () => {
    it('creates a gate reconciler function', () => {
      const reconciler = createDogfoodGateReconciler({
        getContext: () => ({
          authorType: 'ai-agent',
          repository: 'test',
          metrics: {},
  ...
  describe('createDogfoodAutonomyReconciler()', () => {
    it('creates an autonomy reconciler function', () => {
      const reconciler = createDogfoodAutonomyReconciler({
  ...
  describe('reference re-exports', () => {
    it('createPipelineReconciler is exported', () => {
      expect(typeof createPipelineReconciler).toBe('function');
    });

    it('createGateReconciler is exported', () => {
      expect(typeof createGateReconciler).toBe('function');
    });

    it('createAutonomyReconciler is exported', () => {
      expect(typeof createAutonomyReconciler).toBe('function');
    });
